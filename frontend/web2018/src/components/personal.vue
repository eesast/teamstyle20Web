...
<div id="personal">
    ...
    <div class="part2" style="vertical-align: top;">
        ...
        <el-collapse v-model="activeNames" @change="handleChange">
            ...
            <el-table-column prop="winner" label="吃鸡队伍" min-width="25%">
                <!-- <template slot-scope="scope">
            ...
            <el-table-column prop="teams" label="比赛详情" min-width="20%">
                <template slot-scope="scope">
                    <div @click="">查看详情</div>
                </template>
            </el-table-column>
            <el-table-column prop="download" min-width="34%">
                <template slot-scope="scope">
                <el-button  @click="perdownload" :disabled="scope.row.state">下载回放</el-button>
                </template>
            </el-table-column>
            </el-table>
            </el-collapse-item>
